package cn.com.moonisland.utils;
import java.security.MessageDigest;
public class MD5Utils {
	/*
	 * MD5即Message-Digest Algorithm 5（信息-摘要算法5），是一种杂凑算法，
	 * 能将任意字符串运算成固定长度（128位二进制）的字符串 MD5是不可逆的，也就是没有对应的算法，从生产的MD5值逆向得到原始数据。
	 * 一个原始数据只对应一个md5值，但是一个MD5值，可能对应多个原始数据。 Java实现MD5可用系统库自带的MessageDigest类，例子如下
	 */
