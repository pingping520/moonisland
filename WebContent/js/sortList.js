...
$(function(){
  ...
  $.get("../goods/findAllGoods", function(data){
     ...
     for(var i=0;i<data.length;i++){
    	 console.log(data[i]);
    	divlist+='<div class="row"><div class="col-xs-4"><a href="detailPage.html"?goodsId='+data[i].goodsId+'><img src="images/shop01.png"/></a></div>';
    	divlist+='<div class="col-xs-8"><div class="lb2"><a href="detailPage.html">'+data[i].goodsName+'</a></div>';
