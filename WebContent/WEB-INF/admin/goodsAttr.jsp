...
<div style="margin:15px;">
		...
		<fieldset class="layui-elem-field">
			<legend>商品属性</legend><div class="layui-field-box">
		            ...
		            <form class="layui-form" style="float:right;">
		                <div class="layui-form-item" style="margin:0;">
		                    ...
		                    <div class="layui-form-mid layui-word-aux" style="padding:0;">
		                        <button lay-filter="search" class="layui-btn"><i class="fa fa-search" aria-hidden="true"></i>查询</button>
		                    </div>
		                </div>
		            </form>
	        	</blockquote>
    		</div><table class="site-table table-hover" id="" style="vertical-align: middle!important;margin:0px;padding:0px;text-align:center;">
					<thead>
						<tr>	
							<td>属性编号</td>
							<td>商品名称</td>
